...
var rpi_server = "http://nutecrexlab3.ufu.br:80";
var results;
var lab_socket = null;
var switches = 0;
...
$.getScript('http://relle.ufsc.br/exp_data/1/2/welcome.js', function () {
...
$(function () {
    ...
    function sendMessage() {
        ...
        UIimg_interval = setTimeout(function () {
            if (circuit_images.indexOf(switches) >= 0) {
                console.log('loading /exp_data/2/1/resultante/' + switches + '.png');
    ...
    $.ajax({
        ...
        initLabServerCom({ url: 'http://relle.ufsc.br/', path: '/paneldc2' });
    });
